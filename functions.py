...
def filter_keywords(text,keywords):
    #words to be removed
    question=['what','when','why','which','who','how','whose','whom','could','couldn\'t','wouldn\'t','shouldn\'t']
    ...
    pronoun=['i','it\'s','you','your','he','she','them','their','her','him','me','my','it','its','our','these','this','that','those','who','what','which']
